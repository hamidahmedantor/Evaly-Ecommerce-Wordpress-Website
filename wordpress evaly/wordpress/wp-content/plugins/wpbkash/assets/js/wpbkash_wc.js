jQuery(
    function ($) {
        ...
        const wpbkash = {
            ...
            wcbkashInit: async function ($self, redirect = '') {
                ...
                order_id = wpbkash.getOrderID($self);
                    ...
                    success: function (result) {
                        if (result && true === result.success && result.data.transactionStatus != null && result.data.transactionStatus === 'completed') {
                            ...
                            if( result.data.message ) {
                                wpbkash.addErrorMsg(result.data.message);
                            }
                            wpbkash.reload();
            ...
            addErrorMsg: function ($msg) {
                $('#bKashFrameWrapper').after('<div class="wpbkash--msg-overlay"><div class="wpbkash--msg-wrap"><h6>'+ $msg +'</h6></div></div>');
            },
